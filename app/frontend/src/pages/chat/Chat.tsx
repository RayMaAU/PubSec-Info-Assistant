            ...
            <div className={styles.chatRoot}>
                <div className={styles.chatContainer}>
                        ...
                        <div className={styles.chatEmptyState}>
                            {activeChatMode == ChatMode.WorkOnly ? 
                                <div>
                                    ...
                                    <h1 className={styles.chatEmptyStateTitle}>Learn with your knowledge base</h1>
                                </div>
                            : activeChatMode == ChatMode.WorkPlusWeb ?
                                <div>
                                    ...
                                    <h1 className={styles.chatEmptyStateTitle}>Learn with your knowledge base and web information</h1>
                                </div>
                            : //else Ungrounded
                                <div>
                                    <div className={styles.chatEmptyStateHeader}> 
                            ...
                            <span className={styles.chatEmptyObjectives}>
                                <i>AlphaPi Orbis uses AI. Check for mistakes.   </i><a href="https://alphapi.com.au" target="_blank" rel="noopener noreferrer">About AlphaPi</a>
                            </span>
                    ...
                    <div className={styles.chatInput}>
                        {activeChatMode == ChatMode.WorkPlusWeb && (
                            <div className={styles.chatInputWarningMessage}> 
                                {defaultApproach == Approaches.ReadRetrieveRead && 
                                    <div>Questions will be answered by default from Knowledge Base <BuildingMultipleFilled fontSize={"20px"} primaryFill={"rgba(27, 74, 239, 1)"} aria-hidden="true" aria-label="Work Data" /></div>}
                        ...
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. What is Modern Slavery?)"
                            disabled={isLoading}
